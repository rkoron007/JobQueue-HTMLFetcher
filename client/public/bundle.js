...
var _frontend_api_helper = __webpack_require__(28);

__webpack_require__(33);

var _JobShow = __webpack_require__(36);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.handleJob = _this.handleJob.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function handleUpdate(input) {
      ...
      return function (e) {
        return _this2.setState(_defineProperty({}, input, e.target.value));
      };
    }
  }, {
    key: 'handleUrl',
    value: function handleUrl() {
      ...
      (0, _frontend_api_helper.createJobAndAddQueue)({ url: this.state.url }, function (job) {
        _this3.setState({ job: job.message });
      });
      this.setState({ url: '' });
    }
  }, {
    key: 'handleJob',
    value: function handleJob() {
      var _this4 = this;

      (0, _frontend_api_helper.getJobStatus)(this.state.id, function (data) {
        _this4.setState({ url: '', id: '' });
        if (data['obj']) {
          _this4.setState({ job: data['obj'] });
        } else {
          _this4.setState({ job: data['message'] });
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { placeholder: 'www.facebook.com', className: 'url-input',
        ...
        _react2.default.createElement('input', { className: 'url-input', onChange: this.handleUpdate("id"), value: this.state.id }),
        _react2.default.createElement(
          'button',
          { onClick: function onClick() {
              return _this5.handleJob();
            }, className: 'request-button' },
          'Find Job'
        ),
        _react2.default.createElement(_JobShow2.default, { job: this.state.job })
      );
    }
  }]);
...
var createJobAndAddQueue = exports.createJobAndAddQueue = function createJobAndAddQueue(data, callback) {
  var url = data['url'];
  fetch('/jobs/' + url, {
    method: 'POST',
    headers: {
...
var getJobStatus = exports.getJobStatus = function getJobStatus(id, callback) {
  fetch('/jobs/' + id, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
var JobShow = function (_Component) {
  _inherits(JobShow, _Component);

  function JobShow() {
    _classCallCheck(this, JobShow);

    return _possibleConstructorReturn(this, (JobShow.__proto__ || Object.getPrototypeOf(JobShow)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "section",
          null,
          _react2.default.createElement("div", { className: "job-box", dangerouslySetInnerHTML: { __html: this.props.job } })
        )
      );
    }
  }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./JobShow.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./JobShow.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".job-status{\n  margin-top: 5%;\n}\n", ""]);
