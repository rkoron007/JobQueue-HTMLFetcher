...
var _frontend_api_helper = __webpack_require__(31);

__webpack_require__(36);

var _JobShow = __webpack_require__(38);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function handleJob() {
      ...
      (0, _frontend_api_helper.getJobStatus)(this.state.id, function (job) {
        _this3.setState({
          url: '',
          id: ''
        });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { onChange: this.handleUpdate("url"), value: this.state.url }),
        _react2.default.createElement(
          'button',
        ...
        _react2.default.createElement('input', { onChange: this.handleUpdate("id"), value: this.state.id }),
        _react2.default.createElement(
          'button',
